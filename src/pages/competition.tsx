            ...
            <BoxesSection id="overview">
                <Layout.Center>
                    <ExtendedHeader center title="Overview">
                        ...
                        <p>
                            You have until December 8th to create and submit a bot after which it will run in a simulated environment for 45 days. At
                            the end of the simulation period, the top three ranked participants according to our risk-adjusted return metric, namely
                            RoMaD (Return Over Maximum Drawdown) will receive a cash prize. This cash price is related to the performance of the
                            winning bot, but you can find all the fine details in the following paragraphs. Participating Trading Bots can be created
                            with the Python-based <a href="/creator/code-editor">Trality Code Editor</a> or the intuitive drag-and-drop{' '}
            ...
            <Layout.Section id="creativity-pays">
                <Layout.Center>
                    <ExtendedHeader center title="Creativity pays">
                        <p>
                            We recently launched our <a href="/blog/introducing-the-trading-engine-2-0/">Trading Engine 2.0</a> where flexibility took
                            center stage. In that, we provided our creators with the tools they need to build the most advanced trading bots they can
                            imagine. Trality is for those who want the most freedom when developing bots with cutting-edge technology.
                        </p>
                        <p>
                            Our goal with this competition is to expand our community of enthusiastic developers and tech-savvy people in the industry
                            therefore we welcome all kinds of traders to take part. It’s time to get creative and win!
                ...
                <Layout.Center>
                    <ExtendedHeader center title="Contact">
                        <p>
                            ...
                            have any other questions about the platform, our API or just want to give us some feedback then please join our Discord
                            server.
                        </p>
                    </ExtendedHeader>
                </Layout.Center>
