...
import { Headline, MainContainer, Padding, PaddingSizes, SubHeadline, Text, TextLink } from '@trality/web-ui-components';
                ...
                >
                    ...
                    <Padding size={{ bottom: PaddingSizes.TwentyFour }}>
                        <Text bodyType="Body2">
                            ...
                            , the website of TRALITY GmbH, Novaragasse 19/9, 1020 Wien, Austria (FN 504493 b) (“TRALITY,” “we,” “us” and “our” etc.).
                            We are a software and online services provider firm. For additional information, please visit{' '}
                            <TextLink intext href="https://www.trality.com">
                                https://www.trality.com
                            </TextLink>
                            .
                    ...
                    <Text bodyType="Body2">
                        ...
                        Regulation (GDPR) as well as the Federal Act enacting the Telecommunications Act (TKG 2003). This privacy policy (“Policy”)
                        explains how, to what extent and for what purposes we are collecting and subsequently processing personal data and information
                        through our website. TRALITY is the responsible entity ("controller") for the processing of your personal data and information
                        on this website.
                    </Text>
                    <Padding size={{ bottom: PaddingSizes.TwentyFour, top: PaddingSizes.TwentyFour }}>
                    ...
                    <Padding size={{ bottom: PaddingSizes.TwentyFour }}>
                        <Text bodyType="Body2">
                            ...
                            factors specific to his or her physical, physiological, genetic, mental, economic, cultural or social identity, or (c)
                            constitutes individually identifiable information about an individual consumer collected by us online through this website
                            and that we maintain in an accessible form, or that (d) we are otherwise required to protect under applicable data privacy
                            laws (including, but not limited to, national, international and supranational data protection and privacy laws,
                            directives, regulations and comparable legal acts). Examples of Personal Information include your contact details such as
                            your name, email address, birthday or phone number as well as information about your professional education and
                            experience, skills, preferences, membership in professional organizations, etc.;
                        </Text>
                    </Padding>
                    <Padding size={{ bottom: PaddingSizes.TwentyFour }}>
                        <Text bodyType="Body2">
                            ...
                            making available, alignment or combination, blocking, restriction, erasure or destruction;
                        </Text>
                    </Padding>
                    <Padding size={{ bottom: PaddingSizes.TwentyFour }}>
                        <Text bodyType="Body2">
                    ...
                    <Padding size={{ bottom: PaddingSizes.TwentyFour }}>
                        <Text bodyType="Body2">
                            ...
                            <ul>
                                ...
                                <li>
                                    {' '}
                                    for the purposes of our legitimate interests (eg, operation, analysis and improvement of our website, cookies).
                                    You have the right to object to the processing of your personal data based on our legitimate interests with effect
                                    for future processing activities (see under Section 5 "Your rights")
                                </li>
                            </ul>
                        </Text>
                    </Padding>
                    <Padding size={{ bottom: PaddingSizes.TwentyFour }}>
                        <Text bodyType="Body2">
                            ...
                            , the iOS and Android mobile apps and/or{' '}
                            <TextLink intext href="https://www.trality.com">
                                https://www.trality.com
                            </TextLink>
                    ...
                    <Padding size={{ bottom: PaddingSizes.TwentyFour }}>
                        <Text bodyType="Body2">
                            ...
                            security parameters, data concerning the device you access the Site with, location data, IP address and statistical
                            information regarding your use of the Site. Where necessary during your visit of the Site or when revisiting the Site,
                            your Internet browser transmits the cookies including the contained information back to the servers they were initially
                            downloaded from. The analysis and Processing of such information allows us to ensure the functionality of the Site,
                            improve your online experience and optimize the structure and content of the Site. The cookies we use can be categorized
                            as follows:
                        </Text>
                    </Padding>
                    <Padding size={{ bottom: PaddingSizes.TwentyFour }}>
                        <Text bodyType="Body2">
                            ...
                            and are set to be deleted when you leave the Site;
                        </Text>
                    </Padding>
                    <Padding size={{ bottom: PaddingSizes.TwentyFour }}>
                        <Text bodyType="Body2">
                            ...
                            and enable us to personalize the Site. For example, they may allow us to alter the rotation of images on the Site so that
                            different images will be displayed on your next visit;
                        </Text>
                    </Padding>
                    <Padding size={{ bottom: PaddingSizes.TwentyFour }}>
                        <Text bodyType="Body2">
                            ...
                            such cookies. As a result, first-party cookies might log user-related Personal Information accessible to and Processed by
                            third parties on our behalf and subject to our instructions.
                        </Text>
                    </Padding>
                    <Padding size={{ bottom: PaddingSizes.TwentyFour }}>
                        <Text bodyType="Body2">
                            ...
                            device by adjusting the respective settings on your Internet browser. For more information on how to do so in the settings
                            of your particular Internet browser, please see the following information:
                        </Text>
                    </Padding>
                    <Padding size={{ bottom: PaddingSizes.TwentyFour }}>
                        <Text bodyType="Body2">
                    ...
                    <Padding size={{ bottom: PaddingSizes.TwentyFour }}>
                        <Text bodyType="Body2">
                            ...
                            such information is logged by first-party cookies. For additional information on first-party and third-party cookies used
                            on our Site in the context of third-party services and for information on how you might stop such cookies from being
                            stored on your device, please see “Third-Party Services” below.
                        </Text>
                    </Padding>
                    <Padding size={{ bottom: PaddingSizes.TwentyFour, top: PaddingSizes.TwentyFour }}>
                        <Headline headlineType="Headline3">3.3. Third-Party Services</Headline>
                    </Padding>
                    <Padding size={{ bottom: PaddingSizes.TwentyFour }}></Padding>
                    <Padding size={{ bottom: PaddingSizes.TwentyFour }}>
                    ...
                    <Padding size={{ bottom: PaddingSizes.TwentyFour }}>
                        <Text bodyType="Body2">
                            ...
                            US. The data collected in this way is in turn used by Google to provide us with an evaluation of visits to our website and
                            what visitors do once there. This data can also be used to provide other services related to the use of our website and of
                            the internet in general. Google states that it will not connect your IP address to other data. In addition, Google
                            provides further information with regard to its data protection practices at{' '}
                            <TextLink intext href="https://www.google.com/intl/de/policies/privacy/partners">
                    ...
                    <Padding size={{ bottom: PaddingSizes.TwentyFour }}>
                        <Text bodyType="Body2">
                            ...
                            in addition with further information. This add-on can be installed on the most popular browsers and offers you further
                            control over the data that Google collects when you visit our website. The add-on informs Google Analytics' JavaScript
                            (ga.js) that no information about the website visit should be transmitted to Google Analytics. However, this does not
                            prevent information from being transmitted to us or to other web analytics services we may use as detailed herein.
                        </Text>
                    </Padding>
                    <Padding size={{ bottom: PaddingSizes.TwentyFour }}>
                    ...
                    <Padding size={{ bottom: PaddingSizes.TwentyFour }}>
                        <Text bodyType="Body2">
                            ...
                            <TextLink intext href="https://www.privacyshield.gov/participant?id=a2zt0000000GnZKAA0&status=Active">
                                https://www.privacyshield.gov/participant?id=a2zt0000000GnZKAA0&status=Active
                            </TextLink>
                            ) CloudFlare guarantees that it will follow the EU's data protection regulations when processing data in the United
                            States. The legal basis for collecting and processing this information is Art. 6 Para. 1 lit. f) GDPR. Our legitimate
                            interest lies in the secure operation of our website and in its optimization. If you access our website, your queries are
                            forwarded to CloudFlare servers. Statistical access data about your visit to our website is collected and CloudFlare
                            stores a cookie on your terminal device via your browser. Access data includes:
                        </Text>
                    </Padding>
                    <Padding size={{ bottom: PaddingSizes.TwentyFour }}>
                        <ul>
                    ...
                    <Padding size={{ bottom: PaddingSizes.TwentyFour }}>
                        <Text bodyType="Body2">
                            ...
                            offers further information about its data collection and processing as well your rights and your options for protecting
                            your privacy at this link:{' '}
                            <TextLink intext href="https://www.cloudflare.com/privacypolicy/">
                    ...
                    <Padding size={{ bottom: PaddingSizes.TwentyFour }}>
                        <Text bodyType="Body2">
                            ...
                            their help, an individual cookie, i.e. a small file, is stored on the user's device (comparable technologies can also be
                            used instead of cookies). In this file it is noted which websites the user visits, which contents he is interested in and
                            which offers he has clicked, as well as technical information on the browser and operating system, referring websites,
                            visiting time and other information on the use of the online offer. Mixpanel may also link the aforementioned information
                    ...
                    <Padding size={{ bottom: PaddingSizes.TwentyFour }}>
                        <Text bodyType="Body2">
                            ...
                            <TextLink intext href="https://mixpanel.com/optout/">
                    ...
                    <Padding size={{ bottom: PaddingSizes.TwentyFour }}>
                        <Text bodyType="Body2">
                            ...
                            information about your operating system, your internet browser, incoming or outgoing links, the geographical origin of
                            your access, and the type and resolution of the device you are using are evaluated by Hotjar and processed for statistical
                            purposes. Hotjar can also obtain direct feedback from you. Hotjar offers further information about its data protection
                            practices at{' '}
                            <TextLink intext href="https://www.hotjar.com/privacy">
                    ...
                    <Padding size={{ bottom: PaddingSizes.TwentyFour }}>
                        <Text bodyType="Body2">
                            ...
                            a cookie is stored on your device via your browser to prevent any further analysis. Please note, however, that you must
                            click the above link again if you delete the cookies stored on your end device.
                        </Text>
                    </Padding>
                    <Padding size={{ bottom: PaddingSizes.TwentyFour }}>
                    ...
                    <Padding size={{ bottom: PaddingSizes.TwentyFour }}>
                        <Text bodyType="Body2">
                            ...
                            more about TYPEFORM's privacy policy here:{' '}
                            <TextLink intext href="https://admin.typeform.com/to/dwk6gt">
                    ...
                    <Padding size={{ bottom: PaddingSizes.TwentyFour }}>
                        <Text bodyType="Body2">
                            ...
                            session information. The user data (which might also be personal data), such as information on the device or time of
                            error, are collected anonymously and are not used for personal purposes and are subsequently deleted. Further information
                            on this can be found in Sentry's data protection declaration:{' '}
                            <TextLink intext href="https://sentry.io/privacy/">
                    ...
                    <Padding size={{ bottom: PaddingSizes.TwentyFour }}>
                        <Text bodyType="Body2">
                            ...
                            third parties not caused by us (e.g. hacker attack on email accounts or telephone, interception of faxes).
                        </Text>
                    </Padding>
                    <Padding size={{ bottom: PaddingSizes.TwentyFour, top: PaddingSizes.TwentyFour }}>
                    ...
                    <Padding size={{ bottom: PaddingSizes.TwentyFour }}>
                        <Text bodyType="Body2">
                            ...
                            preventing the erasure of your personal data.
                        </Text>
                    </Padding>
                    <Padding size={{ bottom: PaddingSizes.TwentyFour }}>
                    ...
                    <Padding size={{ bottom: PaddingSizes.TwentyFour }}>
                        <Text bodyType="Body2">
                            ...
                            processing your Personal Information prevail. Where Personal Information are processed for direct marketing purposes, you
                            shall have the right to object at any time to processing of Personal Information concerning you. In this case we will
                            cease the processing or your Personal Information for marketing purposes immediately.
                        </Text>
                    </Padding>
                    <Padding size={{ bottom: PaddingSizes.TwentyFour }}>
