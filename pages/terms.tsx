                    ...
                    <Subheader>(18 July 2019)</Subheader>
                        ...
                        <ol>
                          ...
                          <ol>
                            ...
                            <li>
                            The User and TRALITY are each entitled to terminate the service license agreement and any further contract in respect of the Platform ordinarily at the end of each month.
                            </li>
                          </ol>
                          </li>
                          <li><b>Exception to the right of withdrawal</b></li>
                          Pursuant to Art 11 of the Austrian Distance Transaction Act (Fern- und Auswärtsgeschäfte Gesetz "FAGG"), a consumer is entitled to withdraw from a distance contract or a contract concluded outside business premises within 14 days. The period begins with the day of the conclusion of the contract (Art 11 para. 2 lit 3 FAGG). TRALITY shall expressly inform the consumer that, at the express request of the consumer, performance of the contract may commence prior to expiry of the withdrawal period. In this case the consumer loses his right of withdrawal. By ticking the appropriate box during registration on the platform, the consumer expressly consents to immediate performance of the contract by TRALITY. The User acknowledges that this terminates the right of withdrawal in favour of consumers within the meaning of the KSchG for Services offered on the Platform pursuant to Art 18 para. 1 lit 11 FAGG.
                          <li><b>Obligations of the User to cooperate</b>
                          <ol>
                            ...
                            <li>The User must ensure that the technical requirements for receiving e-mails from TRALITY are met at all times.</li>
                          </ol>
                          </li>
                          <li><b>Risks</b>
                          <br/>
                          ...
                          <ol>
                            ...
                            <li>TRALITY's systems are protected against attacks by hackers and viruses at TRALITY’s best efforts and to the extend technically reasonably. However, the risk of such attacks cannot be excluded. If a virus or hacker attack is not caused by TRALITY's grossly negligent or intentional neglect of the security settings, TRALITY shall not be liable for the resulting damage, whatsoever.</li>
                            ...
                            <li>TRALITY accepts no liability for loss of data or computer damage arising from the retrieval of data via the Platform.</li>
                            <li>TRALITY shall not be liable for any third-party content made available on the Platform by other third parties (e.g. external links, banners or other information and advertising offers), as the case may be, to which TRALITY has created a link.</li>
                            <li>Claims for damages of a User who is an entrepreneur expires six months after knowledge of the damage and the damaging party, but no later than two years after TRALITY's conduct giving rise to liability.</li>
                          </ol>
                          </li>

                          <li><b>Copyright, Links</b>
                          <ol>
                            <li>TRALITY hereby reserves all copyrights and IP-rights as used on or in connection with the Platform or the Services provided, including external Services (Docs)- The Platform, the associated Services and the underlying software are protected by copyright and may not be used or modified beyond the granted right of use without the prior written consent of TRALITY. Similarly, the design of the Platform and, in particular, the contents posted on the Platform (e.g. photos, images or texts) are protected by copyright and are subject to other laws for the protection of intellectual property and TRALITY is entitled to the rights thereto, unless otherwise indicated.</li>
                            <li>The direct or indirect references offered on the Platform to external content (e.g. external links, banners or other information and advertising offers) are provided in the interest of the User, as the case may be. The content offered is not designed, edited or otherwise evaluated by TRALITY. TRALITY has no influence on these contents; access to them is the sole responsibility of the User. It is not possible to monitor the content of linked platforms on an ongoing basis.</li>
                          </ol>
                          </li>
                          <li><b>Data protection</b></li>
                          TRALITY's data protection provisions apply to all Users and are an integral part of these GTC. They can be accessed on the website under <a href="https://www.trality.com/privacy">https://www.trality.com/privacy</a>. By ticking the appropriate box during registration on the Platform, the User accepts the data protection provisions and agrees to their content.

                          <li><b>Applicable law and jurisdiction</b>
                          <ol>
                            <li>These GTC as well as all agreements made between the Parties are subject to Austrian law to the exclusion of the UN Convention on Contracts for the International Sale of Goods and the conflict rules of international private law. In the case of consumers, this choice of law shall only apply insofar as the protection granted by the mandatory provisions of the law of the country of the consumer's residence is thereby not jeopardized.</li>
                            <li>The competent court in Vienna, Innere Stadt, is responsible for all claims arising from disputes arising from the contractual relationship. This shall not affect the right of the User to sue at any other mandatory legal venue. For all actions brought by TRALITY against a User who is to be qualified as a consumer and who has his domicile, habitual residence or place of employment in Austria due to disputes arising from the contractual relationship, one of the courts in whose district the consumer has his domicile, habitual residence or place of employment shall have jurisdiction. For users who do not have a residence in Austria at the time of the conclusion of the contract, the legal places of jurisdiction shall apply.</li>
                          </ol>
                          </li>
                          <li><b>Final provisions</b>
                          <ol>
                            <li>TRALITY is entitled to transfer the contractual relationship with the User, if it is an entrepreneur, to third parties without the prior written consent of the User.</li>
                            <li>Each contracting party shall bear the taxes, levies or fees resulting for it from the contractual relationship itself. Any legal transaction fees shall be borne by the User if the User is an entrepreneur.</li>
                            <li>TRALITY expressly reserves the right to rename or change the buttons named in these GTC with quotation marks and execution marks. The names of the buttons in these GTC shall be judged by their meaning and not by their express wording.</li>
                            <li>Should individual provisions of these GTC be or become invalid, this shall not affect the remaining content of the GTC. The invalid provision shall be replaced by a valid provision which is legally valid and comes as close as possible to the economic purpose of the invalid provision.</li>
                            <li>Deviations from these GTC, supplementary agreements or any conflicting terms and conditions of the User shall only be effective if confirmed in writing by TRALITY. This also applies to the agreement to waive this formal requirement. In the event of contradictions between these GTC and deviating written agreements between the contracting parties, the provisions of the deviating agreements shall take precedence.</li>
                          </ol>
                          </li>
                        </ol>
                        </Section>
