                    ...
                    <div>
                        ...
                        <Description>
                            <ul>
                                ...
                                <li>
                                    You bring along full-cycle code development experience (Typescript, Go, Python) including debugging and
                                    performance analysis
                                </li>
                                <li>
                                    Working with MongoDB databases and Redis Caches as well as analyzing the efficiency of and performance of
                                    databases is your alley
                                </li>
                                ...
                                <li>
                                    You have an ability to balance business needs, a sense of urgency, and to ship high quality and pragmatic
                                    solutions
                                </li>
                                <li>
