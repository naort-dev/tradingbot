                    ...
                    <Header title="Privacy Policy for Website Users" subtitle="(information in accordance with Article 13 GDPR, 18 July 2019)">
                        ...
                        <Section>
                            ...
                            <div>
                                ...
                                Depending on your interaction with <a href="https://app.trality.com">https://app.trality.com</a>, <a href="https://app.beta.trality.com">https://app.beta.trality.com</a>, the iOS and Android mobile
                                apps and/or <a href="https://www.trality.com">https://www.trality.com</a>, the following Personal Information may be processed by us for the purposes as set
                        ...
                        <Section>
                            ...
                            <p>
                            <b>Chrome:</b> <a href="https://www.google.com/intl/en/chrome/browser/privacy/">https://www.google.com/intl/en/chrome/browser/privacy/</a>
                            </p>
                            <p>
                            <b>Firefox:</b> <a href="https://support.mozilla.org/en-US/products/firefox/protect-your-privacy">https://support.mozilla.org/en-US/products/firefox/protect-your-privacy</a>
                            </p>
                            <p>
                            <b>Safari:</b> <a href="http://www.apple.com/privacy/manage-your-privacy/">http://www.apple.com/privacy/manage-your-privacy/</a>
                            </p>
                            <p>
                        ...
                        <Section>
                            ...
                            <p>
                            Through certification according to the EU-US Privacy Shield: <a href="https://www.privacyshield.gov/participant?id=a2zt000000001L5AAI&status=Active">https://www.privacyshield.gov/participant?id=a2zt000000001L5AAI&status=Active</a> Google guarantees that it will follow the EU's data protection regulations when processing data in the United States.
                            </p>
                            <p>
                            ...
                            Google states that it will not connect your IP address to other data. In addition, Google provides further information with regard to its data protection practices at <a href="https://www.google.com/intl/de/policies/privacy/partners">https://www.google.com/intl/de/policies/privacy/partners</a>, including options you can exercise to prevent such use of your data.
                            </p>
                            <p>
                            In addition, Google offers an opt-out add-on at <a href="https://tools.google.com/dlpage/gaoptout?hl=en">https://tools.google.com/dlpage/gaoptout?hl=en</a> in addition with further information. This add-on can be installed on the most popular browsers and offers you further control over the data that Google collects when you visit our website. The add-on informs Google Analytics' JavaScript (ga.js) that no information about the website visit should be transmitted to Google Analytics. However, this does not prevent information from being transmitted to us or to other web analytics services we may use as detailed herein.
                            </p>
                            <p><b>CloudFlare</b></p>
                            To secure our website and to optimize loading times, we use the CloudFlare CDN (content delivery network). This is a service of Cloudflare Inc., 101 Townsend Street, San Francisco, California 94107, USA ("CloudFlare").

                            Through certification according to the EU-US Privacy Shield (<a href="https://www.privacyshield.gov/participant?id=a2zt0000000GnZKAA0&status=Active">https://www.privacyshield.gov/participant?id=a2zt0000000GnZKAA0&status=Active</a>) CloudFlare guarantees that it will follow the EU's data protection regulations when processing data in the United States.
                            ...
                            <p>
                            Further information as well as possible objections to the registration by Mixpanel can be found in the data protection regulations of Mixpanel: <a href="https://mixpanel.com/legal/privacy-policy/">https://mixpanel.com/legal/privacy-policy/</a>.
                            In addition, Mixpanel offers an opt-out add-on at <a href="https://mixpanel.com/optout/">https://mixpanel.com/optout/</a>.
                            </p>
                            <p><b>Hotjar</b></p>
                            ...
                            <a href="https://www.hotjar.com/opt-out">https://www.hotjar.com/opt-out</a> a cookie is stored on your device via your browser to prevent any further analysis. Please note, however, that you must click the above link again if you delete the cookies stored on your end device.
                            </p>
                            <p><b>Typeform </b></p>
                            We use the Typeform service (TYPEFORM S.L., Passatge de la Pau 10 Bis, 1-2, Spain) ("Typeform"). Typeform is a website integration used to embed forms (such as surveys, polls and quizzes) on the Trality platform. Users are free to complete these forms. If they do, the users answers are being sent to Trality as well as the typeform platform. You can find out more about TYPEFORM's privacy policy here: <a href="https://admin.typeform.com/to/dwk6gt">https://admin.typeform.com/to/dwk6gt</a>.
                            <p><b>Sentry </b></p>
                            WWe use the services of Sentry (Functional Software, Inc. dba Sentry, 132 Hawthorne Street, San Francisco, CA 94107) ("Sentry"). Sentry is an open-source error tracking software that helps developers monitor and fix crashes in real time. It documents bugs and error reports for our front end services, which includes error parameters as well as user and session information. The user data (which might also be personal data), such as information on the device or time of error, are collected anonymously and are not used for personal purposes and are subsequently deleted. Further information on this can be found in Sentry's data protection declaration: <a href="https://sentry.io/privacy/">https://sentry.io/privacy/</a>.
                            </div>
                        </Section>
                        <Section>
                        ...
                        <Section>
                            ...
                            <p><b>Rectification and erasure of data</b></p>
                            ...
                            <p><b>Limitation of processing</b></p>
                            ...
                            <p><b>Complaint</b></p>
                            You have the right to lodge a complaint with the Austrian Data Protection Authority (Österreichische Datenschutzbehörde), Wickenburggasse 8, 1080 Wien, +43 1 531 15-202525, E-Mail: dsb@dsb.gv.at if you believe that your rights to protection of your personal data have been infringed.
                            </div>
                        </Section>
                        <Section>
