        ...
        <LayoutDivided imageIn="left">
            ...
            <div>
                <Content>
                    <h1>Create bots.</h1>
                    <p>
                        We believe that building a trading bot is pretty cool. That's why we crafted the Trality Bot Creator: the most advanced editor
                        of its kind that leaves nothing to be desired. The cherry on the cake: publish your bot to our Trality Bot Marketplace and
                        generate risk free side-income.
                    </p>
                    <ul>
